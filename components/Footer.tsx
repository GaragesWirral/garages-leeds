        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center text-primary font-bold">GL</div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/70">
              <li><a href="#enquiry" className="hover:text-white transition-colors">Get a Quote</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/70">
              ...
              <li className="flex items-center gap-2">
                ...
                <a href="tel:07519667044" className="hover:text-white transition-colors">07519 667044</a>
              </li>
            </ul>
          </div>
        </div>
